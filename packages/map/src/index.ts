...
import type { PanEventDetail } from 'duoyun-ui/elements/gesture';
...
@customElement('gem-bind-map')
@adoptedStyle(style)
@aria({ role: 'img' })
export class GemBindMapElement extends DuoyunLoadableBaseElement {
